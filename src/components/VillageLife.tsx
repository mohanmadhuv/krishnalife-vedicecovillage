...
export default function VillageLife() {
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-8 py-24 sm:px-16 sm:py-32">
      <h2 className="text-ink">Ways to Connect</h2>

      <div className="mt-14 grid gap-6 sm:mt-16 sm:grid-cols-2">
        <div className="flex aspect-square items-center justify-center rounded-2xl border border-neutral-200 bg-neutral-50">
